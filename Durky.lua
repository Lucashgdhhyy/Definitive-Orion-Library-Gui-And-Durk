...
Tab:AddParagraph("Portugues Brasil","Este Script e uma compilação de todos os jogos que eu ja trouse scripts✨.Esse Script Somente suporta linguagem Inglês Por enquanto..") Tab:AddParagraph("Licencia Pt-Br","# Licença de Uso do Script Lua
...
**Licença de Uso:**
Você está autorizado a usar, modificar e distribuir este script, desde que inclua o reconhecimento explícito de **LtGamesRoblox** como o criador original do projeto. O nome do canal deve ser claramente visível em todas as cópias ou versões significativamente alteradas do script.
